...
export const EXTRA_ATTRIBUTE_SUGGESTIONS: ReadonlyArray<{
  ...
  },
  {
    ...
    hint: 'Cricket Chirper sleep_plants duration (plants show Zzz; damage wakes)',
    type: 'number',
    defaultValue: 2,
  },
  {
    key: 'sleepColumnRange',
    label: 'Sleep column range',
    hint: 'Cricket Chirper sleep_plants affection along the lane',
    type: 'number',
    defaultValue: 2,
  },
  {
    key: 'sleepLaneRange',
    label: 'Sleep lane range',
    hint: 'Cricket Chirper sleep_plants affection across lanes (0 = same lane only)',
    type: 'number',
    defaultValue: 1,
  },
  {
    key: 'sleepMaxTargets',
    label: 'Sleep max targets',
    hint: 'Max plants Cricket Chirper can put to sleep per chirp',
    type: 'number',
    defaultValue: 3,
  },
  {
